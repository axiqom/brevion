...
- Brand mark: `brevion_logo_package.zip` only → `public/brand/raw/5.png` + `8.png`–`26.png` (never `6.png`/`7.png`; never redraw/crop/AI-generate). Porcelain chrome → `brand/raw/18.png` (not 17); hero → `brand/raw/15.png` on `bg-carbon` plate; aluminum-only → `17.png`; favicon/apple-touch → `brand/raw/9.png`. Derivatives forbidden. See `public/brand/MANIFEST.md`.
